...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args) {
        ...
        print(3, jedis.lrange(listName, 0, 3));
        ...
        jedis.hset(userKey, "phone", "188888888888");
        ...
        //如果不存在设置进去，如果存在就不设置
        jedis.hsetnx(userKey, "school", "cumt");
        jedis.hsetnx(userKey, "name", "Allen");
      ...
      /*  System.out.println(jedis.srem(likeKey1,"10"));*/
        ...
        print(31, jedis.srandmember(likeKey1, 5));
        ...
        print(33, jedis.zcount(rankKey, 60, 100));
        print(34, jedis.zscore(rankKey, "Lucy"));
        jedis.zincrby(rankKey, 8, "Lucy");
